...
class TestNegativeTestEmailnotvalid():
  ...
  def test_negativeTestEmailnotvalid(self):
    # Test name: Negative Test - Email not valid
    ...
    # 6 | type | id=email | nino.stenfidz87
    self.driver.find_element(By.ID, "email").send_keys("nino.stenfidz87")
